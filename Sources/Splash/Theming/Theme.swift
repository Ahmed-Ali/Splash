...
public struct Theme {
    ...
    public var plainTextColor: SColor
    /// What color to use for the background
    public var backgroundColor: SColor
    /// What color to use for the text's highlighted tokens
    public var tokenColors: [TokenType: SColor]

    public init(font: Font,
                plainTextColor: SColor,
                tokenColors: [TokenType: SColor],
                backgroundColor: SColor = SColor(white: 0.2, alpha: 1)) {
        self.font = font
